...
- 使用本地标签槽位协议承接 LLM 输出，由插件校验并组装 NovelAI V4/V4.5 的全局、人物正向与人物负向结构，同时保留旧格式兼容。
- 完善多人提示词的人数标签、人物索引与正负绑定，并统一 BestNAI、YesNAI 的二至六人人物位置映射。
- 优化精准/随机模式的服装、动作与场景补全；提示词生成前两次保留服务商默认思考，仅在连续空正文后第三次关闭思考兜底。
